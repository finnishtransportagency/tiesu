...
CONSTRAINT "RYS_HISTORIA" PRIMARY KEY ("RIVI_ID"));

CREATE SEQUENCE "RYS_HIST_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1000 CACHE 20 NOORDER  NOCYCLE ;