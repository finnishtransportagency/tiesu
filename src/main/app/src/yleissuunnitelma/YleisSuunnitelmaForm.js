...
import { yleisSuunnitelmaStatusRes } from "../stores/YleisSuunnitelmaStore";
...
export class YleisSuunnitelmaForm extends React.Component {
    render() {
        const {
            edit,
            onSubmit,
        ...
        const kohteet = [
            { value: 0, label: "moottoritie tai moottoriliikennetie" },
            { value: 4, label: "ohituskaistatie" },
            { value: 1, label: "maantie" },
            { value: 2, label: "eritasoliittymä" },
            { value: 7, label: "siltapaikka" },
            { value: 11, label: "muu" }
        ];

        let resources = {
            suunnitelmanStatus: yleisSuunnitelmaStatusRes,
            kohde1: kohteet,
            kohde2: kohteet
        };
            ...
            >
                {formApi => (
                    <form onSubmit={formApi.submitForm}>
                        <Collapse
                            header={`Yleissuunnitelma: ${values.nimi || ""}`}
                            isOpened={true}
                        >
                        ...
                        >
                            ...
                            <div className="form-group row">
                                ...
                                <div className="col-sm-6">
                                    <div className="col-sm-12">
                                        <label
                                            htmlFor="suunnitelmaLaadittu"
                                            className="row"
                                        >
                                            Tiesuunnitelma laadittu
                                        </label>
                                        <div className="row">
                                            <TextArea
                                                field="suunnitelmaLaadittu"
                                                type="text"
                                                className="tk-field form-control"
                                                id="suunnitelmaLaadittu"
                                                rows="3"
                                                placeholder=""
                                                readOnly={!edit}
                                            />
