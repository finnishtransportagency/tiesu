...
import { YleisSuunnitelmaFilter } from "./YleisSuunnitelmaFilter";
import { LinkToItem } from "../grid/CustomColumns";

export default class YleisSuunnitelmaGriddle extends React.Component {
    render() {
        ...
        return (
            <CustomGriddle
                dataStore={dataStore}
                customfilter={YleisSuunnitelmaFilter}
