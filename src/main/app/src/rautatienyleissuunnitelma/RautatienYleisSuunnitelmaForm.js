...
} from "../stores/RautatienYleisSuunnitelmaStore";
...
export class RautatienYleisSuunnitelmaForm extends React.Component {
    render() {
        const {
            edit,
            onSubmit,
        ...
        suunnitelmanStatusEnum.forEach((item, index) => {
            if (item) {
            ...
            >
                {formApi => (
                    <form onSubmit={formApi.submitForm}>
                        <Collapse
                            header={`Rautatien yleissuunnitelma: ${values.nimi ||
                                ""}`}
                            isOpened={true}
                        >
                        ...
                        <Collapse header={"Kohteen tiedot"} isOpened={true}>
                                ...
                                <div className="col-sm-4">
                                    <div className="col-sm-12">
                                        <label
                                            ...
                                            className="row"
                                        >
                                            Sisältää rautatien lakkaamisen
                                        </label>
                                        <div className="row">
                                            <RadioGroup
                            ...
                            <div className="form-group row">
                                ...
                                <div className="col-sm-4">
                                    <div className="col-sm-12">
                                        <label htmlFor="kohde3" className="row">
                                            Kohde 3
                                        </label>
                                        <div className="row">
                                            <Select
