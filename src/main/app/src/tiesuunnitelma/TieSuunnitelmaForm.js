...
import { kohdeRes, suunnitelmanStatusRes } from "../stores/TieSuunnitelmaStore";
...
export class TieSuunnitelmaForm extends React.Component {
    render() {
        const {
            edit,
            onSubmit,
        ...
        let resources = { suunnitelmanStatus: [], kohde1: [], kohde2: [] };
        suunnitelmanStatusRes.forEach((item, index) => {
            resources.suunnitelmanStatus.push({
                value: item.id,
                label: item.label,
        ...
        values.yvaHanke = (values.yvaHanke !== null && typeof values.yvaHanke !== "undefined")
            ...
            : null;
        values.sisaltaaMaantienLakkaamisen = (values.sisaltaaMaantienLakkaamisen !== null && typeof values.sisaltaaMaantienLakkaamisen !== "undefined")
            ? values.sisaltaaMaantienLakkaamisen.toString()
            : null;
        values.sisaltaaRataSuunnittelua = (values.sisaltaaRataSuunnittelua !== null && typeof values.sisaltaaRataSuunnittelua !== "undefined")
            ? values.sisaltaaRataSuunnittelua.toString()
            : null;
        ...
        return (
            <Form
                ...
                onSubmit={values => {
                    ...
                    values.sisaltaaMaantienLakkaamisen = parseInt(values.sisaltaaMaantienLakkaamisen, 10);
                    values.sisaltaaRataSuunnittelua = parseInt(values.sisaltaaRataSuunnittelua, 10);
            ...
            >
                {formApi => (
                    <form onSubmit={formApi.submitForm}>
                        <Collapse
                            header={`Tiesuunnitelma: ${values.nimi || ""}`}
                            isOpened={true}
                        >
                        ...
                        <Collapse header={"Kohteen tiedot"} isOpened={true}>
                            <div className="form-group row">
                                <div className="col-sm-4">
                                    <div className="col-sm-12">
                                        <label
                                            htmlFor="sisaltaaMaantienLakkaamisen"
                                            className="row"
                                        >
                                            Sisältää maantien lakkaamisen
                                        </label>
                                        <div className="row">
                                            <RadioGroup
                                                id="sisaltaaMaantienLakkaamisen"
                                                className="tk-field form-control"
                                                readOnly={!edit}
                                                field="sisaltaaMaantienLakkaamisen"
                                            >
                                                {group => (
                                                    <div className="row">
                                                        <div className="col-xs-6 col-md-6 col-lg-2 nowrap">
                                ...
                                <div className="col-sm-4">
                                    <div className="col-sm-12">
                                        <label
                                            htmlFor="sisaltaaRataSuunnittelua"
                                            className="row"
                                        >
                                            Sisältää ratasuunnittelua
                                        </label>
                                        <div className="row">
                                            <RadioGroup
                                                id="sisaltaaRataSuunnittelua"
                                                className="tk-field form-control"
                                                readOnly={!edit}
                                                field="sisaltaaRataSuunnittelua"
                                            >
                                                {group => (
                                                    <div className="row">
                                                        <div className="col-xs-6 col-md-6 col-lg-2 nowrap">
                        ...
                        >
                            ...
                            <div className="form-group row">
                                <div className="col-sm-6">
                                    <div className="col-sm-12">
                                        <label
                                            htmlFor="maantietoimitusTehty"
                                            className="row"
                                        >
                                            Maantietoimitus käynnistynyt
                                            (pp.kk.vvvv)
                                        </label>
                                        <div className="row">
                                            <CustomDatePicker
                                                field="maantietoimitusTehty"
                                                className="tk-field form-control"
                                                id="maantietoimitusTehty"
                                                dateFormat="D.M.YYYY"
                                                readOnly={!edit}
                                            />
                                        </div>
                            ...
                            <div className="form-group row">
                                <div className="col-sm-6">
                                    <div className="col-sm-12">
                                        <label
                                            htmlFor="liikenteeseenOsaLuovutus"
                                            className="row"
                                        >
                                            Liikenteeseenluovutus, osaluovutus
                                            (pp.kk.vvvv)
                                        </label>
                                        <div className="row">
                                            <CustomDatePicker
                                                field="liikenteeseenOsaLuovutus"
                                                className="tk-field form-control"
                                                id="liikenteeseenOsaLuovutus"
                                                dateFormat="D.M.YYYY"
                                                readOnly={!edit}
                                            />
                                        </div>
                                ...
                                <div className="col-sm-6">
                                    <div className="col-sm-12">
                                        <label
                                            htmlFor="liikenteeseenKokoLuovutus"
                                            className="row"
                                        >
                                            Liikenteeseenluovutus, kokoluovutus
                                            (pp.kk.vvvv)
                                        </label>
                                        <div className="row">
                                            <CustomDatePicker
                                                field="liikenteeseenKokoLuovutus"
                                                className="tk-field form-control"
                                                id="liikenteeseenKokoLuovutus"
                                                dateFormat="D.M.YYYY"
                                                readOnly={!edit}
                                            />
                                        </div>
