...
import { TieSuunnitelmaFilter } from "./TieSuunnitelmaFilter";
import { LinkToItem } from "../grid/CustomColumns";

export default class TieSuunnitelmaGriddle extends React.Component {
    render() {
        ...
        return (
            <CustomGriddle
                dataStore={dataStore}
                customfilter={TieSuunnitelmaFilter}
