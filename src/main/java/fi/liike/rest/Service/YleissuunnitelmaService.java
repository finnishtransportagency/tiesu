...
import fi.liike.rest.Dao.Hibernate.YleissuunnitelmaDaoImpl;
import fi.liike.rest.Dao.MainDao;
import fi.liike.rest.api.*;
import fi.liike.rest.api.dto.YleissuunnitelmaConverter;
...
public class YleissuunnitelmaService extends MainService implements Service {

	private MainDao dao;
	private YleissuunnitelmaConverter converter;
	private final Logger LOG = LoggerFactory.getLogger(YleissuunnitelmaService.class);

	public YleissuunnitelmaService() {
		dao = new YleissuunnitelmaDaoImpl();
		converter = new YleissuunnitelmaConverter();
	}
