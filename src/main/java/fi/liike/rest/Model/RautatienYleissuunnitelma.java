...
@Entity
@Table(name="rautatien_yleissuunnitelma")
public class RautatienYleissuunnitelma extends Haettava implements Serializable {
	...
	public String toString() {
		return "RautatienYleisuunnitelma[tunnus=" + tunnus + ", nimi=" + nimi + "]";
	}
