...
@Entity
@Table(name = "rt_historia")
public class RataSuunnitelmaHistory implements Serializable, HaettavaHistory {
	...
	@SequenceGenerator(name = "seq_gen", sequenceName = "rt_hist_seq")
    ...
    @Column(name="KAYTTOONOTTOLUOVUTUS_OSA")
	private Date kayttoonottoLuovutusOsa;
    
    @Column(name="KAYTTOONOTTOLUOVUTUS_KOKO")
	private Date kayttoonottoLuovutusKoko;

    @Column(name="SISTIESUUNNITTELUA")
	private Integer sisaltaaTieSuunnittelua;

	@Column(name="RATATOIMITUSTEHTY")
	private Date ratatoimitusTehty;
	...
	public String toString() {
		return "RataSuunnitelmaHistory[tunnus=" + tunnus + ", nimi=" + nimi + "]";
	}
	...
	public Date getKayttoonottoLuovutusOsa() {
		return kayttoonottoLuovutusOsa;
	}

	public void setKayttoonottoLuovutusOsa(Date kayttoonottoLuovutusOsa) {
		this.kayttoonottoLuovutusOsa = kayttoonottoLuovutusOsa;
	}

	public Date getKayttoonottoLuovutusKoko() {
		return kayttoonottoLuovutusKoko;
	}

	public void setKayttoonottoLuovutusKoko(Date kayttoonottoLuovutusKoko) {
		this.kayttoonottoLuovutusKoko = kayttoonottoLuovutusKoko;
	}
	...
	public Integer getSisaltaaTieSuunnittelua() {
		return sisaltaaTieSuunnittelua;
	}

	public void setSisaltaaTieSuunnittelua(Integer sisaltaaTieSuunnittelua) {
		this.sisaltaaTieSuunnittelua = sisaltaaTieSuunnittelua;
	}

	public Date getRatatoimitusTehty() {
		return ratatoimitusTehty;
	}

	public void setRatatoimitusTehty(Date ratatoimitusTehty) {
		this.ratatoimitusTehty = ratatoimitusTehty;
	}
}
