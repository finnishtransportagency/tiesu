...
@Entity
@Table(name="ratasuunnitelma")
public class RataSuunnitelma extends Haettava implements Serializable {
	...
	public Integer getSisaltaaTieSuunnittelua() {
		return this.sisaltaaTieSuunnittelua;
	}
	...
	public String toString() {
		return "RataSuunnitelma[tunnus=" + tunnus + ", nimi=" + nimi + "]";
	}
