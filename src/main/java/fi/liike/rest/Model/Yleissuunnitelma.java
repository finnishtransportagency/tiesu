...
@Entity
@Table(name="yleissuunitelma")
public class Yleissuunnitelma extends Haettava implements Serializable {
	...
	@Id
	@Column(name="YS_WID", unique = true, nullable = false)
	private Integer tunnus;	

    @Column(name="YLEISSUUNNITELMAN_NIMI")
    private String nimi;

    @Column(name="KASITTELIJA")
    private String kasittelija;

    @Column(name="YLEISSUUNITELMAN_KUVAUS")
	...
	@Column(name="LAINVOIMASUUS_PAATTYY")
	...
	@Column(name="TIESUUNNITELMA_LAADITTU")
	...
	public String toString() {
		return "Tien yleisuunnitelma[tunnus=" + tunnus + ", nimi=" + nimi + "]";
	}
