...
@Entity
@Table(name = "tiesuunnitelmahistoria")
public class TiesuunnitelmaHistory implements Serializable, HaettavaHistory {
	...
	@Column(name="VALTIO_OSUUS")
	private Float kustannuksetValtioOsuus;
	
	@Column(name="KUNTA")
	private Float kustannuksetKunta;
	
	@Column(name="KUNTA_OSUUS")
	private Float kustannuksetKuntaOsuus;
	
	@Column(name="MUUT")
	private Float kustannuksetMuut;
	
	@Column(name="MUUT_OSUUS")
	private Float kustannuksetMuutOsuus;
	...
	public Float getKustannuksetValtioOsuus() {
		return kustannuksetValtioOsuus;
	}

	public void setKustannuksetValtioOsuus(Float kustannuksetValtioOsuus) {
		this.kustannuksetValtioOsuus = kustannuksetValtioOsuus;
	}
	...
	public Float getKustannuksetKuntaOsuus() {
		return kustannuksetKuntaOsuus;
	}

	public void setKustannuksetKuntaOsuus(Float kustannuksetKuntaOsuus) {
		this.kustannuksetKuntaOsuus = kustannuksetKuntaOsuus;
	}
	...
	public Float getKustannuksetMuutOsuus() {
		return kustannuksetMuutOsuus;
	}

	public void setKustannuksetMuutOsuus(Float kustannuksetMuutOsuus) {
		this.kustannuksetMuutOsuus = kustannuksetMuutOsuus;
	}
	...
	public String toString() {
		return "TiesuunnitelmaHistory[tunnus=" + tunnus + ", nimi=" + nimi + "]";
	}
	...
	public Integer getSisaltaaRataSuunnittelua() {
		return this.sisaltaaRataSuunnittelua;
	}
