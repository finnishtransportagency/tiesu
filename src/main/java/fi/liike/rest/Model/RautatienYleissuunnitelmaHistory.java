...
@Entity
@Table(name = "rys_historia")
public class RautatienYleissuunnitelmaHistory implements Serializable, HaettavaHistory {
	...
	@SequenceGenerator(name = "seq_gen", sequenceName = "rys_hist_seq")
	...
	public String toString() {
		return "RautatienYleissuunnitelmaHistory[tunnus=" + tunnus + ", nimi=" + nimi + "]";
	}
