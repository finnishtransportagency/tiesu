...
public class YleissuunnitelmaConverter implements Converter {

	public YleissuunnitelmaConverter() {
	}

	@Override
	public Haettava dtoToDomain(ContentDto dtoContent) {
		YleissuunnitelmaDto data = (YleissuunnitelmaDto) dtoContent;
		Yleissuunnitelma result = new Yleissuunnitelma();
	...
	public ContentDto modelToDto(Haettava modelObject, Integer... parentId) {
		if (modelObject == null)
			return null;
		Yleissuunnitelma data = (Yleissuunnitelma) modelObject;
		YleissuunnitelmaDto result = new YleissuunnitelmaDto();
		result.setTunnus(data.getTunnus());
		result.setNimi(data.getNimi());
