...
public class TiesuunnitelmaDto extends ContentDto {
	...
	private String maantietoimitusTehty;
	...
	public String getMaantietoimitusTehty() {
		return maantietoimitusTehty;
	}

	public void setMaantietoimitusTehty(String maantietoimitusTehty) {
