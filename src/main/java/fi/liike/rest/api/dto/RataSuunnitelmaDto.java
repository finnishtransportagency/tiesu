...
public class RataSuunnitelmaDto extends ContentDto {
	...
	private String kayttoonottoLuovutusOsa;

	private String kayttoonottoLuovutusKoko;

	private Integer sisaltaaTieSuunnittelua;

	private String ratatoimitusTehty;
	...
	public String getKayttoonottoLuovutusOsa() {
		return kayttoonottoLuovutusOsa;
	}

	public void setKayttoonottoLuovutusOsa(String kayttoonottoLuovutusOsa) {
		this.kayttoonottoLuovutusOsa = kayttoonottoLuovutusOsa;
	}

	public String getKayttoonottoLuovutusKoko() {
		return kayttoonottoLuovutusKoko;
	}

	public void setKayttoonottoLuovutusKoko(String kayttoonottoLuovutusKoko) {
	...
	public String getRatatoimitusTehty() {
		return ratatoimitusTehty;
	}

	public void setRatatoimitusTehty(String ratatoimitusTehty) {
