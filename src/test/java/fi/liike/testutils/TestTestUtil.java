...
public class TestTestUtil {
	...
	public void testJsonToSql() {
		...
		assertEquals(
				"insert into parametrit (AVAIN, ARVO, RIVIMUOKKAAJATUNNUS, KUVAUS, OTSIKKO) values ('jarjestelma', 'https://extranet.liikennevirasto.fi/forms/fr/Tiesu/jarjestelmatieto_yllapito', 'solita', 'Lomake tietojen muokkaamiseen.', 'Jarjestelmatieto')",
				sql2);
